...
class WorkspaceSettings(BaseModel):
    ...
    workspace_root: str = ".workspace-data"
    upload_batch_dir: str = "upload-batches"
    pending_workspace_dir: str = "pending-workspaces"
    session_dir: str = "sessions"

    # 文件限制
    max_file_size: int = 10 * 1024 * 1024  # 10MB
    max_batch_files: int = 20
    max_batch_size: int = 50 * 1024 * 1024  # 50MB
    max_session_files: int = 100

    # 批次过期时间（小时）
    batch_ttl_hours: int = 168  # 7 天
